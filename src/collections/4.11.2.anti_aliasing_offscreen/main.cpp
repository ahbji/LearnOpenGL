...
int main()
{
    ...
    frameBuffer->setupVertices();
    frameBuffer->initMultisampleFrameBuffer(SCR_WIDTH, SCR_HEIGHT);
...
void loopFunc()
{
    ...
    frameBuffer->drawMultisample(SCR_WIDTH, SCR_HEIGHT, drawScenes, bgColor);
}