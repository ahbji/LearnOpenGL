...
int main()
{
    ...
    materialCubeShader = new Shader("light_casters_spot_cube_vertex.glsl", "light_casters_spot_cube_frag.glsl");
...
void loopFunc()
{
    ...
    spotLight->apply(materialCubeShader, DEFAULT_SPOT_LIGHT_ID, lightPos, -glm::normalize(lightPos));
    delete spotLight;
    spotLight = nullptr;
