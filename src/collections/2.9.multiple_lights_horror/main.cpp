...
void loopFunc()
{
    ...
    glm::vec3 diffuseColor = glm::vec3(0.05f);
    ...
    SpotLight *spotLight = new SpotLight(camera.Position, spotLightAmbient, spotLightDiffuse, spotLightSpecular, constant, linear, quadratic, glm::cos(glm::radians(10.0f)), glm::cos(glm::radians(15.0f)));
