...
int main()
{
    ...
    // initTexture();
    initTexture("resources/textures/container.jpg", &texture0, "texture0", 0, GL_RGB);
    // initAlphaTexture("resources/textures/awesomeface.png", &texture1, "texture1", 1);
    initTexture("resources/textures/awesomeface.png", &texture1, "texture1", 1, GL_RGBA);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        bindTexture(GL_TEXTURE0, texture0);
        bindTexture(GL_TEXTURE1, texture1);
