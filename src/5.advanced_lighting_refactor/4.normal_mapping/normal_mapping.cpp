...
void renderQuad()
{
    if (quadVAO == 0)
    {
        ...
        glm::vec2 uv2(0.0f, 0.0f); // 原点
        glm::vec2 uv3(1.0f, 0.0f);  
        glm::vec2 uv4(1.0f, 1.0f);
        // normal vector
        glm::vec3 nm(0.0f, 0.0f, 1.0f); // 法向量指向 z
        ...
        // 三角形 1
        // ----------
        glm::vec3 edge1 = pos2 - pos1; // e(p1, p2)
        glm::vec3 edge2 = pos3 - pos1; // e(p1, p3)
        glm::vec2 deltaUV1 = uv2 - uv1; // uv(uv1, uv2) = (0, -1)
        glm::vec2 deltaUV2 = uv3 - uv1; // uv(uv1, uv3) = (1, -1)

        float f = 1.0f / (deltaUV1.x * deltaUV2.y - deltaUV2.x * deltaUV1.y); // 1 除以矩阵的行列式
        ...
        // 三角形 2
        // ----------
        edge1 = pos3 - pos1; // e(p1, p3)
        edge2 = pos4 - pos1; // e(p1, p4)
        deltaUV1 = uv3 - uv1; // uv(uv1, uv3) = (1, -1)
        deltaUV2 = uv4 - uv1; // uv(uv1, uv4) = (1, 0)
