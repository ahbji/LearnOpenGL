...
int main()
{
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(glGetUniformLocation(shader.ID, "pointLights[0].diffuse"), 1.0f, 1.0f, 1.0f); 
        ...
        glUniform3f(glGetUniformLocation(shader.ID, "pointLights[1].diffuse"), 1.0f, 1.0f, 1.0f); 
        glUniform3f(glGetUniformLocation(shader.ID, "pointLights[1].specular"), 1.0f, 1.0f, 1.0f);
