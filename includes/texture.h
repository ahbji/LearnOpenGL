...
public:
     ...
     * @param flipY 是否反转 Y 轴
     */
    Texture(const char* texturePath, bool gammaCorrection = false, bool flipY = false);
...
private:
     ...
     * @return 返回纹理对象指针
     */
    void loadMipMap(const char* texturePath, bool gammaCorrection = false, bool flipY = false);
};
...
private:
     ...
     */
    void unBind();
    void loadCubemap(std::vector<std::string> faces, bool gammaCorrection = false, bool flipY = false);
};
